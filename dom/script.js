...
// Object
// Model
// объект ы котором хранится весь код
// console.dir(document.body.children[0].innerText) добраться до "text"
// console.dir(document.body.children[0].style.color='red') поменять текст текста

//селекторы DOM есть двe группы
// getElementBy
// console.dir(document.getElementsByClassName("red")[0].style.background='red') через классы
// console.dir(document.getElementById("red").style.background='red') через id


// 2 спасоб селектора querySelector
// console.dir(document.querySelector('p')) по тегу
// console.dir(document.querySelector('.red'))  по классу
//  console.dir(document.querySelector('#red')) по id
// console.dir(document.querySelectorAll('p')) обращение ко всем p если без All берет только одну p

//изменить каждую вторую на зеленую 
...
//  let arr=document.querySelector(".link").innerText
// console.dir(arr)

// Напишите функцию, которая вернет массив с текстами внутри тэгов - a.

// let arr=Array.from(document.querySelectorAll(".link"))
...
// создание елемента и добавление одного елемента на другой
// const text=document.querySelector(".text")
// const nav=document.querySelector(".nav")
// let desc=document.createElement("p")
// desc.innerText="12343"
// nav.appendChild(desc)


// Напишите функцию, которая добавляет div элемент внутрь 
// элемента с селектором #append-div
...
// Напишите функцию, которая добавляет ul элемент внутрь 
// элемента с селектором #append-div у ul элемента должен быть айди 
...
// const obj = {
//     "id": 1,
//     "title": "Fjallraven — рюкзак складной № 1, вмещает 15 ноутбуков", 
//     "price": 109.95,
//     "description": "Идеальный рюкзак для повседневного использования и прогулок в лесу. Тайник ваш ноутбук (до 15 дюймов) в мягком чехле, ваш повседневный",
...
// const getHtml = () => {
    ...
    // image.src=obj.image
    // image.alt="bag"
    // let boxTilte=document.createElement(title)
    // boxTilte.className="box__title"
    // boxTilte.innerText=obj.title
    // box.appendChild(boxTilte)
    // let boxDesc=document.createElement(title)
    // boxDesc.className="box__Desc"
    // boxDesc.innerText=obj.description
    // box.appendChild(boxDesc)
    // let boxPrice=document.createElement(title)
    // boxPrice.className="box__Price"
    // boxPrice.innerText=obj.price
...
// divImg.src=obj[i].image
// divImg.alt=obj[i].category
...
// desc.innerText=obj[i].description
...
// события это когда пользователь делает какое-то действие 
...
// let square=document.querySelector(".box")
// let accert=document.querySelector(".accert")
// accert.addEventListener("click",() => {
//     square.style.opacity=0
//     let text=document.querySelector(".accert__text")
//     text.style.opacity=1
//     })
//     let reject=document.querySelector(".reject")
//     reject.addEventListener("click",() => {
//     square.style.opacity=0
//     let text1=document.querySelector(".reject__text")
...
// })
//он нам выдаст что пользователь написал он работает так же как hover css

// let btn=document.querySelector("input")
// btn.addEventListener("keydown" , (e)=>{
// console.dir(e.key);
// })Раюотает на кнопки enter, ctrl,alt
...
// let inpc=document.querySelector("#c")
// let inpd=document.querySelector("#d")
// let inps=document.querySelector("#s")
// let inpe=document.querySelector("#e")
// for (let i = 0; i < inputs.length; i++){
//     inputs[i].addEventListener("input",(e)=>{
//     console.log(box.style.boxShadow= `${inpa.value}px, ${inpb.value}px, ${inpc.value}px, ${inpd.value}px, ${inps.value}, ${inpe.value}px`);
//     })
// }
